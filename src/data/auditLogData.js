...
// Platform-wide event tracking stored in localStorage.
...
export function addAuditEvent(action, details = {}) {
  ...
  try {
    localStorage.setItem(AUDIT_LOG_KEY, JSON.stringify(events.slice(0, AUDIT_MAX_ENTRIES)))
  } catch {}
  return entry
}
...
// ── Load recent events (dashboard widget) ─────────────────────
